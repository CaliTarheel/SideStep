...
fn main() {
    ...
    writeln!(log, "t,plates,parcels,cont_frac,mean_v,max_v,subducted,created,accreted,absorbed,cont_lost,cont_grown,rifts,merges,initiations,active_rifts,sea_level").unwrap();
    ...
    for k in 0..=n_steps {
        ...
        writeln!(log, "{},{},{},{:.4},{:.2},{:.2},{},{},{},{},{},{},{},{},{},{},{:.1}", w.t, s.n_plates, s.n_parcels, s.cont_frac, s.mean_v, s.max_v,
            s.subducted, s.created, s.accreted, s.absorbed, s.cont_lost, s.cont_grown, s.rifts, s.merges, s.initiations, w.rifts.len(), w.sea_level).unwrap();
